...
while completed:
    ...
    user_choice = input(f"What would you like to drink ? {drinks}: ").lower()
...
"""
sufficient = CoffeeMaker.is_resource_sufficient(user_choice)
print(sufficient)
...
"""
process_coins = MoneyMachine().process_coins()
print(process_coins)
...
made_payment = MoneyMachine().make_payment(process_coins)
print(made_payment)
...
"""
if made_payment and sufficient:
    print(CoffeeMaker.make_coffee(user_choice))
    completed = True
else:
    completed = False
